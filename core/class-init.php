...
class Init {
	...
	public function reg_public_styles() {
		$public_footer_css = plugins_url( 'public/css/sedici-global-footer-public-reducido.css', dirname( __DIR__ ) . '/multisite-footer.php' );		wp_register_style("multisite-manager-general-css", $public_footer_css);
